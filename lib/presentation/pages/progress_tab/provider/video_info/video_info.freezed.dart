...
abstract class $VideoInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? url, String? title, String? thumbnail});
}
...
class _$VideoInfoImpl implements _VideoInfo {
  const _$VideoInfoImpl({this.url = '', this.title = '', this.thumbnail = ''});
  ...
  @override
  String toString() {
    return 'VideoInfo(url: $url, title: $title, thumbnail: $thumbnail)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, url, title, thumbnail);
...
abstract class _VideoInfo implements VideoInfo {
  const factory _VideoInfo(
      {final String? url,
      final String? title,
      final String? thumbnail}) = _$VideoInfoImpl;
